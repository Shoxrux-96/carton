  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <text x={-18} y={(yFlapTop + yCenter) / 2 + 4} textAnchor="end" fontSize={8} fill="#3b82f6" fontWeight="bold">{f(L / 2)}</text>
        ...
        <text x={-18} y={(yFlapBot + yCutBot) / 2 + 4} textAnchor="end" fontSize={8} fill="#3b82f6" fontWeight="bold">{f(L / 2)}</text>
